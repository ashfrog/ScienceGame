...
public class LitVCR : MonoBehaviour
{
    ...
    private void OnEnable()
    {
...
#if UNITY_ANDROID
        Settings.ini.Path.MediaPath = Path.Combine(Application.persistentDataPath, "MediaPath");
#else
        ...
        //}
        Debug.Log("MediaPath: " + Settings.ini.Path.MediaPath);
        Debug.Log("Path exists: " + Directory.Exists(Settings.ini.Path.MediaPath));
