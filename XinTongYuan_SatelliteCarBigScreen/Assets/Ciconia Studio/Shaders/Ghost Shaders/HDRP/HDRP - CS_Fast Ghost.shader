Shader "Ciconia Studio/CS_Ghost/HDRP/CS_Fast Ghost"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Space(15)][Header(Fresnel Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_FresnelColor("Color", Color) = (0.6933962,1,0.9814353,1)
		_SelfIllumination("Self Illumination", Float) = 1
		...
		[Space(15)][Header(Refraction________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_Refraction("Refraction", Range( 0 , 2)) = 1.1
		[Space(15)][Header(Transparency Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_FillColorBackground("Fill Color Background", Color) = (0,0,0,0)
		_DesaturateBackground("Desaturate Background", Range( 0 , 1)) = 0
		[Space(10)]_Opacity("Opacity", Range( 0 , 1)) = 0.5
		[Space(15)]_FadeTransparency("Fade", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		HLSLINCLUDE
		#pragma target 4.5
		#pragma exclude_renderers glcore gles gles3 xboxseries playstation 
		...
		Pass
		{
					...
					)
			{
				...
				float4 fetchOpaqueVal15 = ASEHDSampleSceneColor(( (ase_grabScreenPosNorm).xyzw + float4( (( mul( float4( normalizedWorldNormal , 0.0 ), UNITY_MATRIX_V ).xyz * (-1.0 + (_Refraction - 0.0) * (1.0 - -1.0) / (2.0 - 0.0)) )).xyz , 0.0 ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				...
				float OpacitySlider208 = ( 1.0 - ( _Opacity / 1000.0 ) );
				...
				float clampResult556 = clamp( ( _SelfIllumination * 10.0 ) , 0.01 , 100000.0 );
				float clampResult80 = clamp( _FresnelIntensity , 0.0 , 400.0 );
				float fresnelNdotV72 = dot( ase_worldNormal, V );
				...
				float4 lerpResult225 = lerp( ( GrabSreenRefraction16 * clampResult556 ) , _FresnelColor , FresnelMask197);
				float4 Emission263 = lerpResult225;
				
				float clampResult2_g5 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g5 = dot( ase_worldNormal, V );
				float fresnelNode5_g5 = ( _FresnelTransBias + clampResult2_g5 * pow( max( 1.0 - fresnelNdotV5_g5 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g5 = saturate( ( 1.0 - fresnelNode5_g5 ) );
				float Opacity250 = ( (0.5 + (( 1.0 - _FadeTransparency ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) * temp_output_7_0_g5 );
				
				surfaceDescription.Color = Emission263.rgb;
		...
		Pass
		{
					...
					)
			{
				...
				float clampResult2_g5 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g5 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode5_g5 = ( _FresnelTransBias + clampResult2_g5 * pow( max( 1.0 - fresnelNdotV5_g5 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g5 = saturate( ( 1.0 - fresnelNode5_g5 ) );
				float Opacity250 = ( (0.5 + (( 1.0 - _FadeTransparency ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) * temp_output_7_0_g5 );
        ...
        Pass
		{
					...
					)
			{
				...
				ase_worldViewDir = normalize(ase_worldViewDir);
				float clampResult2_g5 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g5 = dot( packedInput.normalWS, ase_worldViewDir );
				float fresnelNode5_g5 = ( _FresnelTransBias + clampResult2_g5 * pow( max( 1.0 - fresnelNdotV5_g5 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g5 = saturate( ( 1.0 - fresnelNode5_g5 ) );
				float Opacity250 = ( (0.5 + (( 1.0 - _FadeTransparency ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) * temp_output_7_0_g5 );
