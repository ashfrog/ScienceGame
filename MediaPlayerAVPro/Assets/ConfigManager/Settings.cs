...
public class MGraphicsSettings : BaseSettings
{
    public MGraphicsSettings(IniConfig config) : base(config, "Graphics")
    {
    }
...
/// 游戏设置
/// </summary>
public class MGameSettings : BaseSettings
{
    private static readonly string[] validDifficulties = { "Easy", "Normal", "Hard" };

    public MGameSettings(IniConfig config) : base(config, "Game")
    {
    }
...
public class MIPSettings : BaseSettings
{
    public MIPSettings(IniConfig config) : base(config, "IPHost")
    {
    }
...
public class MPathSettings : BaseSettings
{
    public MPathSettings(IniConfig config) : base(config, "PathSettings")
    {
    }
